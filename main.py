...
if st.button('Predict', key='predict_button'):
    if not symptoms:
        ...
        st.markdown(f"""
        <div style="background-color: rgb(209, 236, 241); padding: 10px; border-radius: 5px; color: #2C3E50;">
        ...
        st.markdown("""
        <div style="background-color: rgb(209, 236, 241); padding: 10px; border-radius: 5px;">
